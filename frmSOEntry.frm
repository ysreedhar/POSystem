...
Begin VB.Form frmSOEntry 
   ...
   Begin VB.Frame Frame1 
      ...
      Begin VB.ComboBox cboChargeType 
         Height          =   315
         ItemData        =   "frmSOEntry.frx":0442
         Left            =   7080
         List            =   "frmSOEntry.frx":0455
         TabIndex        =   31
         Text            =   "NA"
         Top             =   3840
         Width           =   735
...
ElseIf txtPONumber.Text = "" Then
    MsgBox "Please Enter the SO Number!", vbExclamation
        ex_validate_fields = False
...
If alert = vbOK Then
    ...
    RsAdd.Open "Select * from SO_Header", cn, 3, 2
        RsAdd.AddNew
            ...
            RsAdd.Open "Select * from SO_Details", cn, 3, 2
            RsAdd.AddNew
            ...
            End If
            Next i
            MsgBox "Service Order Saved Successfully", vbInformation, App.Title
            'cmdReset_Click
End If
Xit:
Err.Clear
...
Next i
If dbltotal > 0 Then lblPOtotal.Caption = "Total Value of Service Order = " & txtCurrency.Text & ". " & Format(dbltotal, "###,###,##0.00") Else lblPOtotal.Caption = ""
End Function
